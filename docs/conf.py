# -*- coding: utf-8 -*-
#
# django_event documentation build configuration file, created by
...
project = u'django_event'
copyright = u'2014, Dmitry Panchenko'
...
release = '%s-%s' % (version, __release_tag__) if __release_tag__ else version
...
htmlhelp_basename = 'django_event'
